...
public class MetricRecordByMonthServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            ServletErrorHandler.handleErrorMessage(resp, e.getMessage(), HttpServletResponse.SC_BAD_REQUEST, objectMapper);
        }
    }
    ...
    private void getMetricByDate(HttpServletResponse resp, AuthContext authContext, String month, String year)
            throws NotFoundException, AuthenticationException, IOException, NumberFormatException {
